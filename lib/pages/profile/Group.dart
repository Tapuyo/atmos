...
import 'package:doctor_appointment_booking/pages/profile/member.dart';
...
class GroupdSearch extends StatefulWidget {
  @override
  _GroupdSearchState createState() => _GroupdSearchState();
}

class _GroupdSearchState extends State<GroupdSearch> {
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              CustomButton(
                                ...
                                onPressed: () {
                                 setState(() {
                                   AppVar.gname = snapshot.data[index].gname;
                                   AppVar.gamin = snapshot.data[index].gamin;
                                   AppVar.gamout = snapshot.data[index].gamout;
                                   AppVar.gstr = snapshot.data[index].gstr;
                                 });
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => MemberSearch(snapshot.data[index].gid),
                                    ),
                                  );
